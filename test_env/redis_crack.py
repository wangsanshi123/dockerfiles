...
PATH2 = '/usr/local/redis/bin/redis-cli'
...
if os.path.isfile(PATH) or os.path.isfile(PATH1) or os.path.isfile(PATH2):
    try:
        print(colored('\t*******************************************************************', "green"))
    ...
    print(colored("\tRedis-cli:::::This utility is not present on your system. You need to install it to proceed "
                  "further.", "red"))
